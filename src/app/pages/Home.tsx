      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-8">
            <div className="text-center p-4 sm:p-6 bg-[#6B7C3C] rounded-xl sm:rounded-2xl hover:bg-[#C9B99B] transition-colors duration-300 flex flex-col items-center justify-start h-full">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#3a3a3a] rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                <MapPin className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
              </div>
              <h3 className="text-base sm:text-lg mb-1 sm:mb-2 text-white">Prime Locations</h3>
            ...
            <div className="text-center p-4 sm:p-6 bg-[#6B7C3C] rounded-xl sm:rounded-2xl hover:bg-[#C9B99B] transition-colors duration-300 flex flex-col items-center justify-start h-full">
              ...
              <h3 className="text-base sm:text-lg mb-1 sm:mb-2 text-white">Secure Payments</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="text-center p-4 sm:p-6 bg-[#6B7C3C] rounded-xl sm:rounded-2xl hover:bg-[#C9B99B] transition-colors duration-300 flex flex-col items-center justify-start h-full">
              ...
              <h3 className="text-base sm:text-lg mb-1 sm:mb-2 text-white">Easy Booking</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="text-center p-4 sm:p-6 bg-[#6B7C3C] rounded-xl sm:rounded-2xl hover:bg-[#C9B99B] transition-colors duration-300 flex flex-col items-center justify-start h-full">
              ...
              <h3 className="text-base sm:text-lg mb-1 sm:mb-2 text-white">Quality Guaranteed</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="text-center p-4 sm:p-6 bg-[#6B7C3C] rounded-xl sm:rounded-2xl hover:bg-[#C9B99B] transition-colors duration-300 flex flex-col items-center justify-start h-full">
              ...
              <h3 className="text-base sm:text-lg mb-1 sm:mb-2 text-white">24/7 Support</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="text-center p-4 sm:p-6 bg-[#6B7C3C] rounded-xl sm:rounded-2xl hover:bg-[#C9B99B] transition-colors duration-300 flex flex-col items-center justify-start h-full">
              ...
              <h3 className="text-base sm:text-lg mb-1 sm:mb-2 text-white">Best Price Match</h3>
              <p className="text-xs sm:text-sm text-white">
